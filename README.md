...
如果你想先直观看一下这个项目现在的交互形态，我也把一段实际录屏放进了仓库里：

![Experimental-Research-OpenClaw Demo](assets/demo.gif)

- [查看原始录屏（.mov）](assets/录屏2026-04-03%2017.25.16.mov)

这段录屏更适合用来快速感受整个 Workspace 是怎么串起来工作的。里面能比较直观地看到：

- Workspace / Session 的基本切换方式
- 文件树、聊天区与 Trace 面板的协同关系
- 基于本地文件系统的上下文读取与审计体验
